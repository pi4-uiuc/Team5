...
func_genomefeature_trait <- function(file){
  ...
  # Merge feature from genome (say 10th locus)
  feature <- data.frame(acceNumb,genome_restricted[10,])
...
locus10_nutrition = func_genomefeature_trait(df_traits_nutrition)
